...
import logging
# import sys
# sys.path.append('/home/changbinlu/tuberlin/thesis/RNN-Tutorial/')
...
class Tf_train_ctc(object):
    ...
    def set_up_model(self):
        ...
        self.n_examples_train = 90000
        self.n_examples_dev = 30000
        self.n_examples_test = 30000
    ...
    def run_model(self):
        ...
        with self.graph.as_default(), tf.device('/cpu:0'):
            ...
            _, self.test_ler = self.run_batches(self.data_sets.test, is_training=False,
                                                decode=False, write_to_file=False, epoch=self.epochs,n_examples=self.n_examples_test)
    ...
    def setup_network_and_graph(self):
        ...
        self.input_tensor = tf.placeholder(tf.float32, [None, None, 242], name='input')
            # self.input_tensor = tf.placeholder(tf.float32, [None, None, self.n_input + (2 * self.n_input * self.n_context)], name='input')
        ...
        self.targets = tf.placeholder(tf.int32,[None,self.num_steps], name='targets')
    ...
    def run_training_epochs(self):
        ...
        for epoch in range(self.epochs):
            ...
            self.train_cost, self.train_ler = self.run_batches(
                ...
                write_to_file=False,
                epoch=epoch,
            n_examples=self.n_examples_train)
    ...
    def run_validation_step(self, epoch):
        ...
        _, dev_ler = self.run_batches(self.data_sets.dev,
                                      ...
                                      write_to_file=False,
                                      epoch=epoch,
                                      n_examples=self.n_examples_dev)
    ...
    def run_batches(self, dataset, is_training, decode, write_to_file, epoch,n_examples):
